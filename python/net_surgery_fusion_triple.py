...
consiliencenet_param_file = model_root + 'snapshot/' + 'consilience_nonorm_d2048_drop7_iter_60000.caffemodel'

fusion_proto_file = model_root + 'fusion_triple.prototxt'
fusion_param_file = model_root + 'snapshot/' + 'fusion_triple.caffemodel'
